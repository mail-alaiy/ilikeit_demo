  ...
  const categories = [
    {
      ...
      name: "Winter Wear",
      description:
        "Stay warm and stylish with our premium collection of cozy wear for the chilly season.",
      sectionId: "winter-comfort",
    },
    {
      img: "https://img.abercrombie.com/is/image/anf/KIC_125-5475-00227-301_model1.jpg?policy=product-large",
      name: "Shirts",
      description:
        "Elevate your wardrobe with our collection of trendy and comfortable shirts for every occasion.",
      sectionId: "shirts",
    },
    {
      ...
      name: "T-Shirts",
      description:
        "Casual yet stylish, our t-shirts offer the perfect blend of comfort and fashion.",
      sectionId: "tshirts",
    },
  ];
            ...
            <SwiperSlide key={index}>
              <div className="banner-item rounded shadow-sm overflow-hidden h-full">
                ...
                <div className="banner-content p-3 p-md-4 text-center">
                  <h5 className="element-title text-uppercase font-bold mb-2">
                    {category.name}
                  </h5>
                  ...
                  <a
                    ...
                    className="btn-link text-sm md:text-base text-uppercase text-decoration-none font-semibold hover:text-primary transition-colors"
                  >
                    Shop Now
                  </a>
                </div>
